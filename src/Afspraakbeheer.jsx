...
class Afspraakbeheer extends React.Component{
    ...
    {   e.preventDefault()
        ...
        {  
          ...
          let isZiek = "N"
          this.state.patienten.forEach (element => {if ((element.firstName.toUpperCase() === patientFirstName.toUpperCase()) && 
          ...
          if (patientGeregistreerd === "N")
             alert("Patient met deze voor- en achternaam komt niet in het systeem voor")
          else 
          {
            if (isZiek ==="J")
            ...
            { let alAfspraakIngepland="N"
              let id=0
              this.props.appointments.forEach(element => {if ((element.dentist === dentist) && (element.time == time) && (element.day == day))
              ...
              if (alAfspraakIngepland === "J")
                 alert("Deze tandarts heeft op deze dag en op dit tijdstip al een afspraak")
              else 
              { this.setState({wordtVerwerkt:true})
                this.props.appointments.push({id       : id,
                                              day      : day,
                                              time     : time,
                ...
                this.setState({appointments : this.props.appointments})
                setTimeout(()=>{this.setState({wordtVerwerkt:false})
    ...
    render(){
        ...
        return (<div>
                  ...
                  <form onSubmit={this.handleSubmit}> 
                    ...
                    <div className="regelcontainer">
                       ...
                       <select id="treatment" onChange={this.handleTreatments}>
                          ...
                          <option value="Wortelkanaalbehandelingen">Wortelkanaalbehandelingen</option>
                  ...
                  {wordtVerwerkt ? <p>Nieuwe afspraak geaccordeerd en verwerkt.</p>:<p></p> } 
                </div>)
    }
}
